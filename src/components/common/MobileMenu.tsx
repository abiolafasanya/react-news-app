...
const MobileMenu = ({ onClick }: Action) => {
  ...
  const styles = {
    menuContainer:
      "fixed top-0 left-0 z-50 h-screen w-[300px] bg-white bg-opacity-30 backdrop-filter backdrop-blur-sm",
  };
  return (
    <div className={styles.menuContainer}>
      <div className="flex gap-x-7 items-center border-b py-[3px]">
        <h2 className="text-red-500 my-5 ml-4 font-semibold text-2xl">
          HeadlineHive
        </h2>
